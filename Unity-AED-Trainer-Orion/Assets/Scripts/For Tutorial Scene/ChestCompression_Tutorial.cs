...
public class ChestCompression_Tutorial : MonoBehaviour
{
    ...
    {
        //flags[7](電気ショックが行われて)_hc.ISHand(other)(Colliderに触れているのがLeapのHandで)_checkLeapHandPalmDirectionTrue(PalmDirectionDetectorで手のひらが下向きである)
